package cc.maxmc.dependencydownload.resource;
...
public class DependencyDownloadResource {
    ...
    private final List<JarMavenObject> dependencies = new ArrayList<>();
    ...
    private void readFile(List<String> lines) {
        ...
        for (String line : lines) {
            ...
            JarMavenObject mavenObject;
            if (snapshotTimestamp == null) {
                mavenObject = new ReleaseDependency(
                        group,
                        artifact,
                        version,
                        classifier,
                ...
                mavenObject = new SnapshotDependency(
                        group,
                        artifact,
                        version,
                        classifier,
